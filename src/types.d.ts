...
export interface Textarea {
  ...
  placeholder?: string;
  rows?: number;
  /** Defaults to true for inquiry forms */
  required?: boolean;
}
...
export interface Contact extends Omit<Headline, 'classes'>, Form, Widget {
  /** When true, `id` is placed on the form card for accurate hash scroll (e.g. #contact). */
  anchorForm?: boolean;
  /** Tighter spacing / smaller controls — matches landing quote form. */
  compact?: boolean;
}
